...
| 平台 | 下载 | 状态 |
|---|---|---|
| Windows 10/11 x64 | [SpeakType-Setup-0.19.0.exe](https://github.com/wookat/speaktype/releases/download/v0.19.0/SpeakType-Setup-0.19.0.exe)（~98MB） | ✅ 稳定 |
| Windows 绿色免安装 | [SpeakType-0.19.0-portable.exe](https://github.com/wookat/speaktype/releases/download/v0.19.0/SpeakType-0.19.0-portable.exe)（~87MB） | ✅ 稳定 |
