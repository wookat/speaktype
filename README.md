...
[![Release](https://img.shields.io/badge/Release-v0.16.0-8b5cf6.svg)](https://github.com/wookat/speaktype/releases/latest)
...
|---|---|---|
| Windows 10/11 x64 | [SpeakType-Setup-0.16.0.exe](https://github.com/wookat/speaktype/releases/download/v0.16.0/SpeakType-Setup-0.16.0.exe) (~98MB) | ✅ Stable |
| Windows portable | [SpeakType-0.16.0-portable.exe](https://github.com/wookat/speaktype/releases/download/v0.16.0/SpeakType-0.16.0-portable.exe) (~87MB) | ✅ Stable |
