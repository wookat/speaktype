...
export const zhTW: LocaleDict = {
  ...
  "settings.localModelHint": "中文推薦 sensevoice-small：準確率與速度都明顯優於同體積 whisper，且自帶標點。英語及歐洲語言推薦 parakeet-tdt-0.6b-v3（不支援中文）。",
  "settings.localModelHintWhisper": "whisper 系列勝在語種更全：tiny 最快但易錯，base 均衡，small 更準更慢。",
  "settings.localModelHintParakeetFp32": "Parakeet 原精度版：語種與 parakeet-tdt-0.6b-v3 相同，但不再出現 int8 版偶發的句首吞字（如 \"Please\" 辨成 \"Ple\"）。代價是 2.5GB 下載、載入後約佔 2.7GB 記憶體——記憶體充足且遇過句首缺字時再選它。",
