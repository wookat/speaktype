...
export const zhTW: LocaleDict = {
  ...
  "settings.asrProviderLocal": "內建離線識別（whisper.cpp）",
  "settings.asrLocalHint": "完全在本機識別，不聯網、不需要賬號和金鑰，錄音不離開這臺電腦。首次使用需下載一個模型檔案；整句識別，錄音中不顯示實時文字。",
  ...
  "settings.enhancedVadHint": "用神經網路區分人聲與噪聲，免按自動結束和防幻聽更準。需下載約 35MB 增強包，完全在本機執行。",
  "settings.enhancedVadDownload": "下載增強包（約 35MB）",
