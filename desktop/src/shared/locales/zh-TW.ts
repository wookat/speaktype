...
export const zhTW: LocaleDict = {
  ...
  "transcribe.title": "檔案轉錄",
  "transcribe.subtitle": "音訊檔案離線轉文字，可匯出字幕",
  "transcribe.drop": "拖入音訊檔案，或點擊選擇",
  "transcribe.formats": "支援 mp3 / wav / m4a / ogg / flac 等，全程本機辨識不上傳",
  "transcribe.decoding": "正在解碼音訊…",
  "transcribe.working": "轉錄中… {{percent}}%",
  "transcribe.cancel": "取消",
  "transcribe.result": "共 {{count}} 段",
  "transcribe.copy": "複製全文",
  "transcribe.copied": "已複製",
  "transcribe.copyFailed": "複製失敗，請重試",
  "transcribe.export": "匯出…",
  "transcribe.export.txt": "純文字（.txt）",
  "transcribe.export.txtTs": "帶時間戳文字（.txt）",
  "transcribe.export.srt": "SRT 字幕（.srt）",
  "transcribe.export.vtt": "WebVTT 字幕（.vtt）",
  ...
  "transcribe.parakeetFp32Hint": "目前為原精度版：載入後約佔 2.7GB 記憶體。",
  "nav.settings": "設定",
  "home.title": "按住 {{key}} 鍵，開啟語音輸入",
  "home.subtitle": "鬆開按鍵即自動整理並落到游標處；按一下 {{toggle}} 可免按說話。",
  "home.subtitleNoToggle": "鬆開按鍵即自動整理並落到游標處。",
  "home.subtitleHistoryOnly": "鬆開按鍵即自動整理並儲存到歷史（自動落字已關閉）。",
  "home.activate.title": "還差一步：配置語音識別",
  "home.activate.desc": "登入豆包後 SpeakType 會自動取得語音入口；若狀態仍未就緒，在豆包頁面用一次它自帶的語音輸入即可。也可以在設定裡手動填 App Key。",
  ...
  "home.model.pickHint": "按你平時說的語言選擇模型：",
  "home.ready": "語音識別已就緒",
  "home.stat.sessions": "協作次數",
  "home.stat.words": "生成文字",
  "home.stat.duration": "累計語音輸入",
  "home.stat.saved": "節省時間",
  "home.stat.savedHint": "估算值，統計安裝以來的全部聽寫（清空歷史時歸零）：中日韓內容按手打 60 字/分、口述 200 字/分，其他語言按 40 詞/分、150 詞/分——依每句內容的語言計速，與介面語言無關。",
  "time.seconds": "{{n}} 秒",
  "time.minutes": "{{n}} 分鐘",
  "time.hoursMinutes": "{{h}} 小時 {{m}} 分",
  ...
  "home.steps.4HistoryOnly": "鬆開按鍵，文字儲存到歷史記錄",
  "home.remoteMic": "電腦沒有好麥克風？用手機當麥克風 \u2192",
  "home.persona.current": "當前人設",
  "home.persona.switch": "Alt+1..9 快速切換",
  "home.persona.needLlm": "人設只在設定了 AI 潤色模型後才會影響落字。",
  "home.persona.setupLlm": "去設定 AI 潤色",
  "history.title": "歷史記錄",
  "history.clear": "清空歷史",
  ...
  "history.export": "匯出",
  "history.filterAll": "全部來源",
  "history.filterDictation": "聽寫",
  "history.filterPhone": "手機聽寫",
  "history.filterFile": "檔案轉錄",
  "history.sourceFile": "檔案",
  "history.sourcePhone": "手機",
  ...
  "dict.limitReached": "{{count}} 行未能加入（超出 300 個熱詞上限、超過 20 個字元，或僅含符號）。",
  "dict.notCorrected": "{{count}} 個詞含日文假名或韓文——已儲存，但自動糾錯目前僅支援中文和英文詞。",
  "dict.manage": "管理熱詞",
  ...
  "dict.autoLearnEditors": "絕大多數應用可用。VS Code 等基於 Monaco 的編輯器只有開啟螢幕閱讀器最佳化模式才會暴露你的修改——在 VS Code 裡按 Shift+Alt+F1 開啟。",
  "dict.autoLearnHintRestore": "恢復不可用提示",
  "dict.save": "儲存",
  "dict.clear": "清空",
  ...
  "settings.toggleKeyConflict": "與按住說話鍵或改寫鍵相同，免按模式將被停用，請換一個鍵。",
  ...
  "settings.vadAutoStop": "免按模式長時間靜默自動退出",
  "settings.vadAutoStopHint": "免按模式下持續靜默約一分鐘自動停止聆聽；無論開關，說完一句停頓即落字；長按說話不受影響。",
  "settings.vadSilence": "靜音判定時長",
  "settings.vadSilenceHint": "持續安靜超過該時長即視為說完。",
  "settings.handsFreeParagraphs": "免按模式自動分段",
  "settings.handsFreeParagraphsHint": "免按連續聽寫時，較長停頓後的下一句另起一段（插入空行）；長按說話不受影響。",
  "settings.paragraphBreak": "段落停頓時長",
  "settings.paragraphBreakHint": "停頓達到該時長即另起一段。",
  "settings.voiceCommands": "免按語音命令",
  "settings.voiceCommandsHint":
    "免按聽寫時，整句只說出命令詞即執行編輯動作而非落字：「換行」「另起一段」「刪除上一句」（英文：new line / new paragraph / delete last sentence）。命令詞出現在長句中時照常落字。",
  "toast.voiceCommandDone": "已執行語音命令",
  "toast.voiceCommandFailed": "語音命令未執行",
  "voiceCommand.newline": "換行",
  "voiceCommand.paragraph": "另起一段",
  "voiceCommand.deleteLast": "刪除上一句",
  ...
  "settings.theme": "主題",
  "settings.themeHintSystem": "跟隨系統時隨系統深淺色自動切換。",
  ...
  "download.retrying": "連線中斷，正在重試…",
  "download.retryingSource": "連線中斷，正在透過第 {{index}}/{{total}} 個來源重試（{{host}}）…",
  "download.verifying": "下載完成，正在校驗檔案完整性…",
  "download.errStorage": "下載失敗：無法寫入模型目錄，請檢查磁碟空間與資料夾權限。",
  "download.errChecksum": "下載失敗：檔案校驗未通過，請重試。",
  "download.errNotFound": "下載失敗：所有下載來源都找不到該檔案，請更新到最新版本後重試。",
  "download.errServer": "下載失敗：下載伺服器暫時無法使用（伺服器錯誤），請稍後重試。",
  "settings.themeLight": "淺色",
  "settings.themeDark": "深色",
  "settings.panelPositionTop": "固定頂部",
  "settings.panelPositionBottom": "固定底部",
  "settings.panelPositionAuto": "自動（避讓文字游標）",
  "settings.panelPositionHint": "錄音懸浮條和即時字幕出現在螢幕的哪個位置。自動：預設底部，擋到文字游標時改停頂部。",
  "settings.panelPosition": "懸浮條位置",
  ...
  "settings.remoteMicRelayError": "連不上中轉伺服器——請檢查中轉位址和網路，仍在自動重試…",
  "settings.asr": "語音識別服務",
  "settings.asrHint": "SpeakType 本身不提供識別服務，識別走你自己的賬號：登入豆包即可自動取得 App Key（若仍未就緒，在豆包頁面用一次它自帶的語音輸入），也可以手動填寫。",
  ...
  "settings.asrProviderLocal": "內建離線識別（SenseVoice / Parakeet）",
  ...
  "settings.localModelHint": "中文、日語、韓語、粵語推薦 SenseVoice：準確率與速度都明顯優於同體積 Whisper，且自帶標點。英語及 25 種歐洲語言推薦 Parakeet（不支援中文）。中文（含方言）要更高精度可選 FireRedASR（出字較慢、無即時字幕）。",
  "settings.localModelHintWhisper": "whisper 系列勝在語種更全：tiny 最快但易錯，base 均衡，small 更準更慢。",
  "settings.localModelHintParakeetFp32": "Parakeet 原精度版：語種與辨識速度和標準版 Parakeet 相同，但不再出現標準版（int8）偶發的句首吞字（如 \"Please\" 辨成 \"Ple\"）。代價是 2.5GB 下載、載入後約佔 2.7GB 記憶體——記憶體充足且遇過句首缺字時再選它。",
  "settings.localModelHintFireRed": "FireRedASR：中英雙語加四川、天津、河南等 20 餘種方言的精度優先檔，口語辨識略優於 SenseVoice。代價是 740MB 下載、出字約為 SenseVoice 的 8 倍耗時（10 秒語音約 2 秒）、錄音中無即時字幕，標點交由應用補齊（規則斷句較保守，建議開啟「增強標點」）。",
  "settings.localModelDownload": "下載模型",
  "settings.localModelDownloading": "下載中 {{progress}}%",
  "settings.localModelVerifying": "校驗中…",
  "settings.localModelResume": "繼續下載（已完成 {{progress}}%）",
  "settings.localModelBusy": "正在下載 {{model}}，完成或取消後才能下載此模型",
  "settings.localModelReady": "模型已就緒",
  "settings.localModelDelete": "刪除模型",
  "settings.localModelDeleteConfirm": "確認刪除？再次使用需重新下載",
  "settings.backupSection": "備份",
  "settings.exportConfig": "匯出設定",
  "settings.exportConfigHint": "將偏好設定、詞典、自建人設與按應用規則儲存為 JSON 檔案。API 金鑰與麥克風裝置選擇不隨檔案匯出。",
  "settings.exportConfigBtn": "匯出…",
  "settings.importConfig": "匯入設定",
  "settings.importConfigHint": "從匯出的設定檔還原。本機已填的 API 金鑰會保留。",
  "settings.importConfigBtn": "匯入…",
  "settings.configExported": "設定已匯出",
  "settings.configImported": "設定已匯入並生效",
  "settings.configIgnored": "（跳過 {{count}} 個欄位：未知、型別不符或不隨檔案遷移）",
  "settings.configInvalid": "不是有效的 SpeakType 設定檔",
  "settings.configFailed": "失敗：{{error}}",
  "settings.resetSection": "重設",
  "settings.resetSettings": "還原預設設定",
  "settings.resetSettingsHint": "所有偏好還原為預設值。字典熱詞、依應用人設規則、手機配對碼和目前本地模型選擇保留；歷史記錄和已下載模型不受影響。",
  "settings.resetSettingsBtn": "還原預設設定",
  "settings.resetSettingsConfirm": "確認還原預設設定？",
  "settings.factoryReset": "清除全部資料",
  "settings.factoryResetHint": "刪除全部資料：設定、歷史、字典、已下載模型、日誌、快取和登入資料，然後以全新安裝狀態重新啟動。此操作無法復原。",
  "settings.factoryResetBtn": "清除全部資料",
  "settings.factoryResetConfirm": "確認清除全部資料？",
  ...
  "settings.enhancedVadHint": "用神經網路區分人聲與噪聲，免按自動結束和防幻聽更準。已內建，完全在本機執行。",
  ...
  "settings.localSimplifiedHint": "whisper 中文識別常出繁體，開啟後落字前自動繁→簡。僅辨識語言為中文/粵語或自動偵測時生效；日/韓/英文原樣保留。繁體使用者請保持關閉。",
  ...
  "settings.modelApiKey": "API Key（Ollama 等本地端點可留空）",
  ...
  "settings.about.updateDownload": "下載安裝包（{{size}}MB）",
  "settings.about.updateResume": "繼續下載（已 {{progress}}%）",
  "settings.about.updateInstall": "安裝並重啟",
  "settings.about.updateOpenFolder": "開啟所在資料夾",
  "settings.about.updateRetry": "重試",
  "settings.about.updateFailed": "下載失敗：{{error}}",
  "settings.about.updatePhaseRetrying": "連線中斷，正在重試…",
  "settings.about.updatePhaseVerifying": "正在校驗…",
  "settings.about.updatePortableHint": "可攜版：下載新安裝包後執行它即可升級（設定與歷史不受影響）",
  ...
  "panel.loadingModel": "載入模型中…",
  "panel.polishing": "潤色中…",
  "panel.rewriteBadge": "改寫",
  "panel.micSilent": "未偵測到麥克風輸入——裝置可能在休眠，再按一次試試",
  "panel.rewriting": "改寫中…（原文保留，Esc 取消）",
  "panel.error": "發生錯誤",
  "panel.cancel": "取消",
  "toast.persona": "當前人設",
  ...
  "toast.busy": "上一句還在處理",
  "toast.busyBody": "請稍後再按",
  "toast.exportFailed": "儲存檔案失敗",
  "toast.exportSaved": "已儲存",
  "toast.exportReveal": "開啟所在資料夾",
  "toast.exportNoAccess": "沒有寫入該資料夾的權限，請換個位置儲存。",
  "toast.exportNoSpace": "磁碟已滿，請清理空間或換個磁碟。",
  "toast.exportInUse": "檔案正被其他程式開啟，請關閉後重試。",
  "toast.canceledBody": "未輸入任何文字",
  "toast.updateAvailable": "發現新版本",
  "toast.updateAvailableBody": "v{{version}} 已發布，可在 設定 → 關於 下載更新",
  "toast.updateGoDownload": "去更新",
  ...
  "toast.localModelMissingBody": "本地離線模型還沒下載",
  "toast.downloadModelAction": "去下載模型",
  ...
  "toast.micSilent": "麥克風無輸入",
  "toast.micSilentBody": "這次沒採到任何聲音：麥克風可能休眠、靜音或被其他程式佔用。再按一次通常可恢復，持續如此請到 設定 → 語音辨識 檢查輸入裝置",
  ...
  "toast.rewriteCanceledBody": "已取消改寫，原文未變動",
  ...
  "tray.quit": "退出",
  "error.noAppKey": "尚未配置語音識別：請在設定中登入豆包（必要時用一次它自帶的語音輸入），或手動填寫 App Key",
  ...
  "error.asrRuntimeDamaged": "識別引擎檔案缺失或損壞：重新啟動 SpeakType 可自動修復；若仍失敗請重新安裝",
  ...
  "mac.accessibilityTitle": "需要「輔助使用」權限",
  "mac.accessibilityBody": "SpeakType 透過全域熱鍵監聽按住說話，並用模擬按鍵把文字貼到游標處，這兩項都需要 macOS 的「輔助使用」權限。\n\n請在 系統設定 → 隱私權與安全性 → 輔助使用 中勾選 SpeakType；授權後熱鍵會自動生效，無需重新啟動。",
  "mac.openAccessibility": "開啟系統設定",
  "mac.later": "稍後",
