...
export const en: LocaleDict = {
  ...
  "settings.holdCaptureUnsupported": "Hold-to-talk only takes a single key (incl. mouse side/middle buttons), not combos; use combos like Alt+Q for hands-free mode.",
