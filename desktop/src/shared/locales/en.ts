...
export const en: LocaleDict = {
  ...
  "settings.resetSettingsHint": "Restore all preferences to defaults. Dictionary hotwords, per-app persona rules and the phone pair code are kept; history and downloaded models are not touched.",
