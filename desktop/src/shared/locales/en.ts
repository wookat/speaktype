...
export const en: LocaleDict = {
  ...
  "home.activate.desc":
    "Sign in to Doubao and use its built-in voice input once â€” SpeakType will capture the app key automatically. You can also enter it manually in Settings.",
  ...
  "home.steps.4": "Release the key â€” text lands at your cursor",
  ...
  "history.emptyHint": "Hold the hotkey and speak â€” every entry will be recorded here",
  "history.copy": "Copy",
  ...
  "dict.emptyHint": "Add names and jargon unique to you â€” recognition will respect them",
  "dict.save": "Save",
  "dict.clear": "Clear",
  ...
  "settings.micTesting": "Testingâ€¦",
  "settings.micStop": "Stop",
  "settings.micTestHint": "Speak into the microphone â€” the level bar below should react.",

  "settings.asr": "Speech recognition service",
  "settings.asrHint":
    "SpeakType ships no recognition service of its own â€” it uses your account: sign in to Doubao and use its voice input once to auto-capture the app key, or enter one manually.",
  ...
  "settings.asrLocalHint":
    "Runs fully on this machine â€” no internet, no account, no API key; audio never leaves this computer. Download a model file once; whole-utterance recognition, no live text while recording.",
  ...
  "settings.enhancedVadHint":
    "Uses a neural network to tell speech from noise â€” more accurate auto-stop and hallucination filtering. Requires a ~35MB add-on download; runs fully on this machine.",
  "settings.enhancedVadDownload": "Download add-on (~35MB)",
  "settings.enhancedVadDownloading": "Downloading {{progress}}%",
  "settings.enhancedVadReady": "Add-on ready â€” voice detection upgraded",
  ...
  "settings.asrOpenaiHint":
    "Any service compatible with /audio/transcriptions works (OpenAI / SiliconFlow / Groq / local Whisper). Keys stay on this machine. Whole-utterance recognition â€” no live text while recording.",
  ...
  "settings.modelHint":
    "Any OpenAI-compatible endpoint works. You bring your own model and key â€” both stay on this machine. Leave empty for local cleanup only.",
  ...
  "settings.modelTesting": "Testingâ€¦",
  ...
  "settings.about.openSourceDesc":
    "SpeakType is MIT-licensed and fully open source. Your voice and text never touch our servers â€” recognition and polish connect directly to services you configure.",
  ...
  "settings.about.contributeDesc": "Issues and pull requests are welcome â€” help us build great open-source voice typing.",
  ...
  "panel.connecting": "Connectingâ€¦",
  "panel.recording": "Listening",
  "panel.transcribing": "Transcribingâ€¦",
  "panel.polishing": "Polishingâ€¦",
  ...
  "toast.noSpeechBody": "No speech detected â€” try again",
  ...
  "error.localModelMissing": "Local model not downloaded yet: open Settings â†’ Speech recognition and click \"Download model\"",
  ...
  "history.retry": "Retry",
  "history.retrying": "Retryingâ€¦",
  "history.retryGone": "Audio no longer available (only the last 20 recordings are kept)",
  "history.retryDone": "Retry succeeded â€” copied to clipboard",
  "error.retryHint": "Recording kept â€” press the hotkey again to retry",
  "error.localServerFailed": "Local recognition engine failed to start: check main.log via About â†’ Open log folder and report the issue",
  "error.micDenied": "Microphone access denied: allow desktop apps to use the microphone in Windows Settings â†’ Privacy",
